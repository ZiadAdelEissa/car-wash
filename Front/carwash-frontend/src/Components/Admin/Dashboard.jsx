...
export default function AdminDashboard() {
  ...
  return (
    <div className="Dashboard p-6 bg-[#435565] flex flex-col items-center justify-center text-center mt-[50px]">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex flex-wrap gap-4">
          <a href="/ServicesCrud" className="bg-blue-100 text-blue-700 px-4 py-2 rounded hover:bg-blue-200">
            Manage Services
          </a>
          <a href="/PackagesCRUD" className="bg-green-100 text-green-700 px-4 py-2 rounded hover:bg-green-200">
            Manage Packages
          </a>
          <a href="/BranchCrud" className="bg-purple-100 text-purple-700 px-4 py-2 rounded hover:bg-purple-200">
            Manage Branches
          </a>
